...
import { ResultPesquisaHospitalRepository } from "../result-repository";

export class PrismaResultsPesquisaHospitalTraumaRepository implements ResultPesquisaHospitalRepository {
  async create(
    {
      cargo,
      email,
      ...
      comentario,
      telefoneString,
    }: ResponsesHospitalTraumaDTO): Promise<void> {
    await prisma.result_pesquisa_hospital_trauma.create({
      data: {
        cargo,
        email,
        empresa,
